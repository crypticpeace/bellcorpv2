import { BadgeCheck, HandCoins, DoorOpen, Globe, MessageCircle, ArrowRight, Shirt, Scissors, Luggage } from "lucide-react";
import { COMPANY } from "@/lib/utils";

const BADGES = [
  { icon: BadgeCheck, label: "Quality Products" },
  { icon: HandCoins, label: "Best Pricing" },
  { icon: DoorOpen, label: "Door-to-Door Delivery" },
  { icon: Globe, label: "Across China" },
];

const TILES = [
  { icon: Shirt, label: "Garments & Fashion Wear" },
  { icon: Scissors, label: "Fabrics" },
  { icon: Luggage, label: "Trolley Bags & Luggage" },
];
      ...
      <div className="container grid gap-14 py-16 md:py-20 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div className="animate-fade-up">
          <span className="text-xs font-semibold uppercase tracking-[0.28em] text-coral-light">
            End-to-End Import Partner &middot; China to India
          </span>
          ...
          <p className="mt-6 max-w-md leading-relaxed text-white/70">
            We are your business partner. Bellcorp International sources quality products across
            China and delivers your stock to India &mdash; door to door. You choose the product; we
            give you the best price and simplify your shipment.
          </p>
