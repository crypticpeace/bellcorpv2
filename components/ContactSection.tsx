      ...
      <div className="container grid gap-10 lg:grid-cols-[1fr_1.2fr]">
        ...
        <Reveal>
          ...
          <p className="mt-4 max-w-md text-navy-dark/70">
            We are your business partner &mdash; we help you grow your business from China to India.
            Contact us for anything related to your import, and our team will get back to you with the
            best price and next steps.
          </p>
