import { Shirt, Scissors, Baby, ShoppingBag, Luggage, ShowerHead, Watch, UtensilsCrossed, Gift, PackageSearch } from "lucide-react";
...
const CATS = [
  ...
  { icon: ShowerHead, label: "Bathroom Fittings" },
    ...
    <section id="products" className="section bg-blush">
      <div className="container">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          {CATS.map((c, i) => (
            <Reveal key={c.label} delay={(i % 5) * 50}>
