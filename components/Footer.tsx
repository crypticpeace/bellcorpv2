...
const CATS = [
  "Garments & Fashion Wear", "Fabrics", "Baby Products", "Ladies Handbags & Purses",
  "Fashion Accessories", "Household & Lifestyle", "Gift Articles",
  "Trolley Bags & Luggage", "Bathroom Fittings", "Custom Sourcing",
];
    ...
    <footer className="bg-navy-deep text-white/70">
      ...
      <div className="border-t border-white/10">
        <div className="container py-5 text-center text-xs text-white/50">
          ...
          Global Sourcing &middot; China Imports &middot; End-to-End Shipment &middot; Door-to-Door Delivery
        </div>
      </div>
    </footer>
  );
